...
|--------|-------------|---------------------------|------------------------|---------------------------------|
| NOT    | ![NOT](./images/NOT-gate_circuitverse.png)   | 0→1, 1→0                      | Torch on block          | Inverts a signal                |
| OR     | ![OR](./images/OR-gate_circuitverse.png)     | 00→0, 01→1, 10→1, 11→1        | Dust merger             | Alarm triggers                  |
| AND    | ![AND](./images/AND-gate_circuitverse.png)   | 00→0, 01→0, 10→0, 11→1        | Two torches             | All conditions must be met      |
| NOR    | ![NOR](./images/NOR-gate_circuitverse.png)   | 00→1, 01→0, 10→0, 11→0        | OR with torch           | Memory circuits                 |
| NAND   | ![NAND](./images/NAND-gate_circuitverse.png) | 00→1, 01→1, 10→1, 11→0        | AND with torch          | Digital locks                   |
| XOR    | ![XOR](./images/XOR-gate_circuitverse.png)   | 00→0, 01→1, 10→1, 11→0        | See Lesson 2.4          | Toggle, parity checks           |
| XNOR   | ![XNOR](./images/XNOR-gate_circuitverse.png) | 00→1, 01→0, 10→0, 11→1        | See Lesson 2.6          | Equality detection              |
...
-   **Quiz:**
    ...
    4.  Simplify the expression `(A AND B) OR (A AND NOT B)` using Boolean laws.
        <details>
        <summary><strong>Solution: Quiz Question 4</strong></summary>
    ...
    9.  Given a list of numbers where all numbers appear an even number of times except two numbers that appear once, find those two numbers using XOR.
        <details>
        <summary><strong>Solution: Find Two Unique Numbers</strong></summary>
        ```python
