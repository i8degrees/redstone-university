...
*Figure: The architecture of our Binary-to-BCD converter. The 4-to-16 decoder activates a single line, which then energizes the correct pattern of outputs in the 8-bit wide ROM.*
...
*Figure: The complete system in action. The ALU result is fed into the large Binary-to-BCD converter, whose dual outputs are sent to two separate 7-segment displays, correctly showing the number "13".*
