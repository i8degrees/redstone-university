...
*Figure: A standard logic diagram for a 1-bit full adder, showing the two XOR gates for the Sum and the combination of AND/OR gates for the Carry-Out.*
...
*Figure: A 4-bit ripple-carry adder in Minecraft. Four full adder modules are chained together. The Carry-Out from each module (visible on the repeaters) "ripples" to become the Carry-In for the next.*
