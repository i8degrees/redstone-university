...
![7-segment display in CircuitVerse](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_7-segment-display.png)\
&#xNAN;_&#x46;igure: The symbol for a 7-segment display on CircuitVerse (left) and its function in a basic circuit (right), taking seven inputs and lighting up the segments based on the pattern._\
...
![7-segment display labeled](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_7-segment-display_labeled.png)\
...
![7 Segment Display in Minecraft](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_7-segment-display_minecraft.png)\
...
![Digital Display Subcircuit Abstractions](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_digital-display-subcircuit-abstractions_circuitverse.png)\
&#xNAN;_&#x46;igure: The overall system in CircuitVerse, using subcircuit abstractions for the decoder, encoder, and display to show the high-level signal flow._\
...
![2-to-4 Decoder in CircuitVerse](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_2-to-4-decder_circuitverse.png)\
&#xNAN;_&#x46;igure: The brute-force 2-to-4 decoder in CircuitVerse, using AND gates to recognize each binary pattern._\
...
![2-to-4 Decoder Step 1](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_2-to-4-decoder-1_minecraft.png)\
&#xNAN;_&#x46;igure: 4-line bus with inputs $B1$ and $B0$ and their inversions._\
...
![2-to-4 Decoder Step 2](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_2-to-4-decoder-2_minecraft.png)\
&#xNAN;_&#x46;igure: Single AND gate connected to the $\neg B1$ and $\neg B0$ lines of the bus. The input is set to \`\` \`11\` \`\`, so the $L0$ lamp is OFF. It would be on if the input were \`\` \`00\` \`\`._\
...
![2-to-4 Decoder Step 3](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_2-to-4-decoder-3_minecraft.png)\
...
![4-to-10 Decoder in CircuitVerse](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_4-to-10-decoder_circuitverse.png)\
&#xNAN;_&#x46;igure: The compact 4-to-10 decoder in CircuitVerse, mirroring the Minecraft build with dual buses and NOR-like logic for efficiency._\
...
![Compact 4-to-10 Decoder Step 1](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_4-to-10-decoder-compact-1_minecraft.png)\
&#xNAN;_&#x46;igure: Screenshot showing the 10 output lines on the ground, step 1 of the compact 4-to-10 decoder._\
...
![Compact 4-to-10 Decoder Step 2](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_4-to-10-decoder-compact-2_minecraft.png)\
...
![Compact 4-to-10 Decoder L3 Tapped](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_4-to-10-decoder-compact-3_minecraft.png)\
&#xNAN;_&#x46;igure: The \`L3\` line is now tapped for its \`0011\` identity. With the input set to \`0000\`, the Torch Taps on \`B1\` and \`B0\` activate, correctly detecting a mismatch, powering the \`L3\` wire and turning its lamp OFF. The \`L0\` lamp remains ON, as it's a perfect match._\


To get a closer look at how the taps are placed, check out this isolated view of the `L3` line:

![Isolated L3 Line Close-Up](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_4-to-10-decoder-L3_minecraft.png)\
...
![Testable L3 Line](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_4-to-10-decoder-L3-test_minecraft.png)\
...
![Compact 4-to-10 Decoder](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_4-to-10-decoder-compact-complete_minecraft.png)\
&#xNAN;_&#x46;igure: The complete 4-to-10 compact decoder in action, with input \`0011\` lighting only the \`L3\` lamp._\
...
**The Logic**: The $L\_8$ lamp should turn OFF when the input is `1001`. For $L\_8$ to turn off, its wire needs to be powered. This means one of its "mismatch" taps must have activated.
...
![10-to-7 Encoder in CircuitVerse](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_10-to-7-encoder_circuitverse.png)\
&#xNAN;_&#x46;igure: The 10-to-7 encoder in CircuitVerse, using a diode matrix structure to map the active input line to the correct segment pattern._\
...
![Encoder Output Layer](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_10-to-7-encoder-1_minecraft.png)\
...
![Encoder Two-Layer Structure](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_10-to-7-encoder-2_minecraft.png)\
...
![Encoder L9 Taps Close-Up](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_10-to-7-encoder-L9_minecraft.png)\
...
![Complete 10-to-7 Encoder](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_10-to-7-encoder-complete_minecraft.png)\
...
![Complete Digital Display Isometric](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_complete-digital-display_minecraft.png)\
...
![Complete Digital Display Aerial](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_complete-digital-display-aerial_minecraft.png)\
...
![Full System in CircuitVerse](https://raw.githubusercontent.com/fielding/redstone-university/main/assets/images/04_complete-digital-display_circuitverse.png)\
&#xNAN;_&#x46;igure: The end-to-end binary-to-display system in CircuitVerse, integrating all components from this module and displaying '3' for input \`0011\`._\
...
The letter 'A' can be made with segments `a, b, c, e, f, g`. According to the design of our ROM, which segment line is the _only one_ that would **not** have a torch tap placed on it from the `LA` input line?

<details>

<summary><strong>Show Solution</strong></summary>

The line for the letter 'A' would need to activate every segment _except_ for segment **`d`**. Therefore, `d` is the only segment line that would not get a torch tap.
