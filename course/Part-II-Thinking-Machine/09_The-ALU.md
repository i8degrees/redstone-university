...
<div align="center"><img src="./images/alu-architecture-circuitverse.png" alt="ALU Architecture Diagram" width="512px"/><br/><em>Figure: The high-level architecture of our ALU. Inputs A and B are fed to all lanes in parallel. A multi-bit MUX, controlled by an opcode, selects which result is sent to the final output.</em></div><br/>
...
<div align="center"><img src="./images/alu-lanes-minecraft.png" alt="ALU Lanes Minecraft Build" width="512px"/><br/><em>Figure: The calculation lanes of the ALU built in parallel in Minecraft. Each lane takes the same A and B inputs and calculates its result independently.</em></div><br/>
...
<div align="center"><img src="./images/alu-mux-minecraft.png" alt="ALU MUX Minecraft Build" width="512px"/><br/><em>Figure: The large 4-to-1 MUX array being wired up. The four vertical result buses from the calculation lanes are being fed into the selector, controlled by the decoder at the front.</em></div><br/>
