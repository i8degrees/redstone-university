...
<div align="center"><img src="./images/comparator-circuitverse.png" alt="4-Bit Equality Comparator CircuitVerse Diagram" width="512px"/><br/><em>Figure: The logic for a 4-bit equality comparator. Each pair of bits ($A_i$, $B_i$) is checked by an XNOR gate, and a 4-input AND gate confirms that all pairs are identical.</em></div><br/>
...
<div align="center"><img src="./images/comparator-minecraft.png" alt="4-Bit Equality Comparator Minecraft Build" width="512px"/><br/><em>Figure: The 4-bit equality comparator built in Minecraft. The two 4-bit inputs are at the back, and the single output lamp at the front is lit, indicating the inputs are currently equal.</em></div><br/>
...
<div align="center"><img src="./images/flag-logic-circuitverse.png" alt="Flag Logic CircuitVerse Diagram" width="512px"/><br/><em>Figure: The logic for our 2-bit flag register. A 4-input NOR gate detects the zero condition, while a simple wire taps the MSB for the negative condition.</em></div><br/>
...
<div align="center"><img src="./images/flag-register-minecraft.png" alt="Flag Register Minecraft Build" width="512px"/><br/><em>Figure: The flag logic circuits in Minecraft. The Z flag lamp is lit because the input is `0000`. The N flag lamp is off.</em></div><br/>
